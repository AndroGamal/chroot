        ...
        chroot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    process.getOutputStream().write("echo \"deb http://http.kali.org/kali kali-rolling main contrib non-free\\ndeb-src http://http.kali.org/kali kali-rolling main contrib non-free\">data/local/kali-armhf/etc/apt/sources.list\n".getBytes());
